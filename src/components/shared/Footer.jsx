...
// lucide-react v1.x removed brand icons (Facebook/Linkedin/Instagram no
// longer exported), so these use the official Simple Icons glyphs (CC0).
const socialLinks = [
  {
    label: "Facebook",
    // TODO: replace with the real Sprintexa page URL
    href: "https://www.facebook.com/p/Softflux-61573041870441/",
    path: "M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.707 0-1.259.096-1.675.309a1.686 1.686 0 0 0-.679.622c-.258.42-.374.995-.374 1.752v1.297h3.919l-.386 2.103-.287 1.564h-3.246v8.245C19.396 23.238 24 18.179 24 12.044c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.628 3.874 10.35 9.101 11.647Z",
  },
  {
    label: "LinkedIn",
    // TODO: replace with the real Sprintexa company URL
    href: "https://www.linkedin.com/company/software-flux-solution/posts/?feedView=all",
    path: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z",
  },
  {
    label: "Instagram",
    // TODO: replace with the real Sprintexa profile URL
    href: "https://www.instagram.com/softwarefluxsolution",
    ...
    <footer className="relative w-full bg-background">
      ...
      <Container className="py-14 sm:py-20">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="text-sm font-bold text-foreground">Developed By</h3>
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Sprintexa is designed and developed by{" "}
              {/* TODO: replace with the real Software Flux Solution URL */}
              <a
              ...
              >
                Software Flux Solution
              </a>{" "}
              — a SaaS-focused product studio building scalable platforms for
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground">
              ...
              growing teams manage projects, people, and operations from a
              single place.
            </p>
          </div>
